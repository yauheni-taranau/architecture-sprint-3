...
- Домен: обработка телеметрии
  - Поддомен: управление датчиками
    - Контекст: реагирование системы на сигналы датчиков
    - Контекст: корректировка датчиков
- Домен: Управление пользователем
  - Поддомен: Регистрация новых пользователей
